...
"66666	@"
        ...
        public MainWindow()
        {
            ...
            {
                string ValueTemp;
                string IntTempString;
                int[] IntTempSet = new int[5];
                ValueTemp = str.Split('\t')[1];
                IntTempString = str.Split('\t')[0];
                char[] IntTempCharArray = IntTempString.ToCharArray();
                IntTempSet[0]=(int)char.GetNumericValue(IntTempCharArray[0]);
                IntTempSet[1]=(int)char.GetNumericValue(IntTempCharArray[1]);
                IntTempSet[2]=(int)char.GetNumericValue(IntTempCharArray[2]);
                IntTempSet[3]=(int)char.GetNumericValue(IntTempCharArray[3]);
                IntTempSet[4]=(int)char.GetNumericValue(IntTempCharArray[4]);
                if (IntTempSet.Count() != 5)
                    throw new Exception("String Manipulation Error; Legnth of 1st section should be 5");
                else
                    FormattedDiceware.Add(Convert.ToInt32($"{IntTempSet[0]}{IntTempSet[1]}{IntTempSet[2]}{IntTempSet[3]}{IntTempSet[4]}"), ValueTemp);
            }
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int l = 0; l < Loops; l++)
            {
                ...
                listBox1.Items.Add($"{Dice[0]}{Dice[1]}{Dice[2]}{Dice[3]}{Dice[4]} - {FormattedDiceware[Convert.ToInt32($"{Dice[0]}{Dice[1]}{Dice[2]}{Dice[3]}{Dice[4]}")]}");
            }
        }
